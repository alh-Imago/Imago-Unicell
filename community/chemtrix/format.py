"""
ChemTrix (Chemistry Element) format definitions for UniCell.
...
from cell_format import Chemistry_Element
...
_reg.register_class(Chemistry_Element)  # Chemistry_Element — ChemTrix

__all__ = ["Chemistry_Element"]
