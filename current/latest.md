# Current State (as of 2026-09-21, the PRIORITY CELL on the single bus measured on the real VM (only WEIGHTED mode is fair; weights are 2 bits, masked silently) and the DSP chain as a BLACK BOX monitored at both ends (#814). 1259 tests pass. See `points/points_active.md` #805-#814)
