# top_unicell_super_test_v1.sdc — points.md #320/#321: first real
# Quartus attempt for the super carrier shell (unicell_super_v1.v).
# Same clocking convention as every other project here: 100.00 MHz
