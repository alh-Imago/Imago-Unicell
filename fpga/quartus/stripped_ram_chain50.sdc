# stripped_ram_chain50.sdc — points.md #248 (task 1): 50-cell ram_cell_v1
# chain, first real Quartus size/timing check. Same clocking convention
# as stripped_zone50.sdc (compute cell's own 50-cell base figure) for a
