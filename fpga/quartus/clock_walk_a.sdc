# clock_walk_a.sdc — timing constraints for clock_walk_top_a (Build A of 2)
...
set_clock_groups -asynchronous \
    -group {CLK_100M CLK} \
    -group {refclk_1c_rx0} -group {refclk_1c_rx1} -group {refclk_1c_rx2} \
    -group {refclk_1c_rx3} -group {refclk_1c_rx4} -group {refclk_1c_rx5} \
    -group {refclk_1d_rx0} -group {refclk_1d_rx1} -group {refclk_1d_rx2} \
    -group {refclk_1d_rx3} -group {refclk_1d_rx4} -group {refclk_1d_rx5}
