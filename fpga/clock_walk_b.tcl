# clock_walk_b.tcl — reads Build B's 12-bit locked probe (points.md #30)
# Bit map: 0=1E_RX0 1=1E_RX1 2=1E_RX2 3=1E_RX3 4=1E_RX4 5=1E_RX5
#          6=1F_RX0 7=1F_RX1 8=1F_RX2 9=1F_RX3 10=1F_RX4 11=1F_RX5
#   quartus_stp -t clock_walk_b.tcl [INST] [HWM]
...
set NAMES {1E_RX0 1E_RX1 1E_RX2 1E_RX3 1E_RX4 1E_RX5 1F_RX0 1F_RX1 1F_RX2 1F_RX3 1F_RX4 1F_RX5}
...
if {[catch {
    ...
    puts "=== RESULT (Build B: banks 1E+1F) ==="
    if {$count == 0} {
        puts "ZERO bits locked (out of 12). If Build A was also zero, sweep I/O"
        puts "standards (LVDS/LVPECL/CML) on both halves before concluding anything."
    } elseif {$count == 1} {
