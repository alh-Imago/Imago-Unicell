...
//
// tb_unicell_super_v4.v — points.md #573: cloned from tb_unicell_super_v3.v
...
module tb_unicell_super_v4;
    ...
    initial begin
        ...
        if (errors == 0)
            $display("PASS: unicell_super_v4 -- all 8 cores' proven behavior confirmed UNCHANGED through the real shared external-storage mechanism (one 170-bit register, not 8 separate internal register sets), including the substantive branch cell test (held-reference, per-outcome routing, genuine suppression)");
        else
