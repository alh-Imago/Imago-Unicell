...
//
// top_stripped_zone240_v1.v — points.md #221: density-threshold experiment,
// an 8x30 (240-cell) clone of top_stripped_zone750_v5.v's exact structure
// (same row-buffer fixes #180/#186, same witness-cell freeze mechanism),
// ROWS the only changed dimension (25->8), COLS unchanged (30) so this is
// a controlled comparison against v5's own 750-cell numbers, not a
// different design. Everything below this line is otherwise identical
// to v5 -- see top_stripped_zone750_v5.v's own header for the full
// original design history (points.md #195: goes further than #189/
...
//
// FREEZE_TARGET is r=0,c=10. The opposite corner, ROW[7].COL[29] (was ROW[24].COL[29] in the 750-cell v5 original), is
...
module top_stripped_zone240_v1 (
    input  wire CLK_100M,
    output wire LED0_N,
    output wire LED1_N
);

localparam ROWS = 8;   // #221 density-threshold experiment: 8x30=240 cells, same COLS as v5's 750-cell build, ROWS the only varied dimension
localparam COLS = 30;
...
// wire instead. ROW[7].COL[29] (was ROW[24].COL[29] in the 750-cell v5 original) is the farthest cell from FREEZE_TARGET
