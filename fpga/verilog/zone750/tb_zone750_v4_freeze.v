// tb_zone750_v4_freeze.v — same proof as tb_grid5x5_both_v2_freeze.v, at the
// full 750-cell (25x30) zone scale -- Alan's actual per-zone target.
// Confirms the freeze-cascade exercise threaded into
// top_stripped_zone750_v4.v behaves correctly before this build goes to
// Quartus for re-measurement.
`timescale 1ns / 1ps

module tb_zone750_v4_freeze;
