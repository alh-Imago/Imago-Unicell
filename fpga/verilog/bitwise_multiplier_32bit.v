...
//
// points.md #724: promoted from docs/stripped-cell/design-notes/
// future-core-candidates/bitwise_multiplier_32bit.v into a real RTL
// dependency, for use inside mul_cell_v4.v/mul_cell_v4c.v. Verified
// correct via iverilog before this promotion (real edge cases
// including 0xFFFFFFFF x 0xFFFFFFFF) -- unchanged from its own
// original, contributed form; only this header is new.
