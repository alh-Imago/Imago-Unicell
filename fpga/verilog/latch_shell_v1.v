...
//
// latch_shell_v1.v — same real pattern as `branch_shell_v1.v` (see its
// own header for the full real rationale, points.md #646).
`default_nettype none
`timescale 1ns / 1ps

module latch_shell_v1 #(
    ...
    latch_cell_v4 #(.CELL_ID(CELL_ID)) CORE (
