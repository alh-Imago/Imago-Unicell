...
//
// ram_shell_v1.v — same real pattern as `nano_shell_v1.v`/
// `adder_shell_v1.v`: a real cardinal wrapper, not a core edit.
// `ram_cell_v4.v` itself is untouched. Its own two flat, single-bit
// live-control ports (`active`, `freeze_in`) become real 4-way
// cardinal port sets here, OR-combined internally. See
...
module ram_shell_v1 #(
    ...
    ram_cell_v4 #(.CELL_ID(CELL_ID)) CORE (
