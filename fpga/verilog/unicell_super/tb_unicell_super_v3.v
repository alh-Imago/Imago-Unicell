...
module tb_unicell_super_v3;
    ...
    initial begin
        ...
        if (errors == 0)
            $display("PASS: unicell_super_v3 -- core selection and isolation confirmed correct across all 8 cores, including a substantive real branch cell test (held-reference, per-outcome routing, genuine suppression) through core_select for the first time");
        else
