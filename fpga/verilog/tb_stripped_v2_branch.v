// tb_stripped_v2_branch.v — points.md #140's branch mechanism: a
...
module tb_stripped_v2_branch;
    ...
    unicell_stripped_v2 #(.CELL_ID(16'h0001), .ENABLE_DYNAMIC_ROUTING(1'b1)) T (
