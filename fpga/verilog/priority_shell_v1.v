// priority_shell_v1.v — points.md #730: the real cardinal wrapper
// for priority_cell_v4.v, same real pattern as every other _shell_v1
// file -- a real cardinal wrapper, not a core edit. priority_cell_v4.v
// itself is untouched.
`default_nettype none
`timescale 1ns / 1ps

module priority_shell_v1 #(
    ...
    priority_cell_v4 #(.CELL_ID(CELL_ID)) CORE (
