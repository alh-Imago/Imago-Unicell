...
// shift the proven test reads out_data=0x01002340; WITH it, 0x01002340<<4 = 0x00002340.
...
module tb_zone64_method;
    ...
    initial begin
        ...
        xact(32'h14A00019, 32'h000001F0);  // CMD_SET_METHOD (op25,auth=0xA5): mask_en + nibble_mask=0xF0 (block hi 4 nibbles)
        ...
        $display("after inject: fires=%0d  out_addr=0x%04x  out_data=0x%08x  (want 0x00002340 = 0x01002340<<4)",
                 fires, out_addr, last_out);
        if (fires>0 && last_out===32'h00002340)
