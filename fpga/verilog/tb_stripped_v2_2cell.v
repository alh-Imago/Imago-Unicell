// tb_stripped_v2_2cell.v — smallest possible chain test for unicell_stripped_v2
...
module tb_stripped_v2_2cell;
    ...
    reg [255:0] cfgA_data  = 128'h0, cfgB_data = 128'h0;
    ...
    unicell_stripped_v2 #(.CELL_ID(16'h0001)) A (
        .clk(clk), .rst(rst),
    ...
    unicell_stripped_v2 #(.CELL_ID(16'h0002)) B (
        .clk(clk), .rst(rst),
    ...
    initial begin
        $dumpfile("/tmp/tb_stripped_v2_2cell.vcd");
        $dumpvars(0, tb_stripped_v2_2cell);
