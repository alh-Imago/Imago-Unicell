...
//
// ram_shell_v1c.v — points.md #720: the real cardinal wrapper for
// ram_cell_v4c.v (the carrier-specific variant, internal addon chain
...
module ram_shell_v1c #(
    ...
    ram_cell_v4c #(.CELL_ID(CELL_ID)) CORE (
