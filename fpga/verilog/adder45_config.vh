...
// Source: docs/design-notes/packed_adder_cluster_mesh.md.
// Placement respects the constraint found 2026-07-05: any two cells
// sharing a broadcast address (a fan-out relay + its 'natural' sibling)
// are placed in the SAME cluster, resolving the conflict between the
// shared-broadcast fan-out trick and the zone bridge's address-decode
// routing (each address routes to exactly one owning cluster).

    assign cfg_target[0]      = 16'd0;  // G0
    assign cfg_input_addr[0]  = 16'd0;
    assign cfg_output_addr[0] = 16'd34;
    ...
    assign cfg_output_addr[1] = 16'd3;
    ...
    assign cfg_input_addr[2]  = 16'd3;
    assign cfg_output_addr[2] = 16'd4;
    ...
    assign cfg_input_addr[3]  = 16'd4;
    assign cfg_output_addr[3] = 16'd35;
    ...
    assign cfg_target[4]      = 16'd33;  // P0_fanout_r3
    assign cfg_input_addr[4]  = 16'd35;
    ...
    assign cfg_cluster[4]     = 4'd1;

    assign cfg_target[5]      = 16'd34;  // DELAY_G1
    assign cfg_input_addr[5]  = 16'd34;
    assign cfg_output_addr[5] = 16'd65;
    ...
    assign cfg_cluster[5]     = 4'd1;

    assign cfg_target[6]      = 16'd64;  // DELAY_G1_fanout_r1
    assign cfg_input_addr[6]  = 16'd65;
    assign cfg_output_addr[6] = 16'd36;
    ...
    assign cfg_cluster[6]     = 4'd2;

    assign cfg_target[7]      = 16'd65;  // SHL_G1
    assign cfg_input_addr[7]  = 16'd65;
    assign cfg_output_addr[7] = 16'd4;
    ...
    assign cfg_cluster[7]     = 4'd2;

    assign cfg_target[8]      = 16'd3;  // SHL_P1
    assign cfg_input_addr[8]  = 16'd3;
    assign cfg_output_addr[8] = 16'd35;
    ...
    assign cfg_cluster[8]     = 4'd0;

    assign cfg_target[9]      = 16'd4;  // AND_PG1
    assign cfg_input_addr[9]  = 16'd4;
    assign cfg_output_addr[9] = 16'd36;
    ...
    assign cfg_cluster[9]     = 4'd0;

    assign cfg_target[10]      = 16'd35;  // AND_P1
    assign cfg_input_addr[10]  = 16'd35;
    assign cfg_output_addr[10] = 16'd68;
    ...
    assign cfg_cluster[10]     = 4'd1;

    assign cfg_target[11]      = 16'd66;  // AND_P1_fanout_r1
    assign cfg_input_addr[11]  = 16'd68;
    ...
    assign cfg_target[12]      = 16'd96;  // AND_P1_fanout_r2
    ...
    assign cfg_cluster[12]     = 4'd3;

    assign cfg_target[13]      = 16'd36;  // OR_G1
    assign cfg_input_addr[13]  = 16'd36;
    assign cfg_output_addr[13] = 16'd67;
    ...
    assign cfg_cluster[13]     = 4'd1;

    assign cfg_target[14]      = 16'd67;  // DELAY_G2
    assign cfg_input_addr[14]  = 16'd67;
    assign cfg_output_addr[14] = 16'd98;
    ...
    assign cfg_target[15]      = 16'd97;  // DELAY_G2_fanout_r1
    assign cfg_input_addr[15]  = 16'd98;
    ...
    assign cfg_target[16]      = 16'd98;  // SHL_G2
    assign cfg_input_addr[16]  = 16'd98;
    ...
    assign cfg_target[17]      = 16'd68;  // SHL_P2
    assign cfg_input_addr[17]  = 16'd68;
    ...
    assign cfg_output_addr[19] = 16'd131;
    ...
    assign cfg_input_addr[20]  = 16'd131;
    assign cfg_output_addr[20] = 16'd132;
    ...
    assign cfg_input_addr[21]  = 16'd132;
    ...
    assign cfg_output_addr[22] = 16'd160;
    ...
    assign cfg_target[23]      = 16'd160;  // DELAY_G3
    assign cfg_input_addr[23]  = 16'd160;
    assign cfg_output_addr[23] = 16'd162;
    ...
    assign cfg_cluster[23]     = 4'd5;

    assign cfg_target[24]      = 16'd161;  // DELAY_G3_fanout_r1
    assign cfg_input_addr[24]  = 16'd162;
    assign cfg_output_addr[24] = 16'd164;
    ...
    assign cfg_cluster[24]     = 4'd5;

    assign cfg_target[25]      = 16'd162;  // SHL_G3
    assign cfg_input_addr[25]  = 16'd162;
    assign cfg_output_addr[25] = 16'd132;
    ...
    assign cfg_target[26]      = 16'd131;  // SHL_P3
    assign cfg_input_addr[26]  = 16'd131;
    ...
    assign cfg_cluster[26]     = 4'd4;

    assign cfg_target[27]      = 16'd132;  // AND_PG3
    assign cfg_input_addr[27]  = 16'd132;
    assign cfg_output_addr[27] = 16'd164;
    ...
    assign cfg_target[29]      = 16'd192;  // AND_P3_fanout_r1
    assign cfg_input_addr[29]  = 16'd195;
    assign cfg_output_addr[29] = 16'd196;
    ...
    assign cfg_cluster[29]     = 4'd6;

    assign cfg_target[30]      = 16'd193;  // AND_P3_fanout_r2
    assign cfg_input_addr[30]  = 16'd196;
    ...
    assign cfg_target[31]      = 16'd164;  // OR_G3
    assign cfg_input_addr[31]  = 16'd164;
    ...
    assign cfg_target[33]      = 16'd224;  // DELAY_G4_fanout_r1
    assign cfg_input_addr[33]  = 16'd225;
    assign cfg_output_addr[33] = 16'd257;
    ...
    assign cfg_cluster[33]     = 4'd7;

    assign cfg_target[34]      = 16'd225;  // SHL_G4
    assign cfg_input_addr[34]  = 16'd225;
    assign cfg_output_addr[34] = 16'd196;
    ...
    assign cfg_cluster[34]     = 4'd7;

    assign cfg_target[35]      = 16'd195;  // SHL_P4
    assign cfg_input_addr[35]  = 16'd195;
    ...
    assign cfg_cluster[35]     = 4'd6;

    assign cfg_target[36]      = 16'd196;  // AND_PG4
    assign cfg_input_addr[36]  = 16'd196;
    assign cfg_output_addr[36] = 16'd257;
    ...
    assign cfg_input_addr[38]  = 16'd228;
    assign cfg_output_addr[38] = 16'd259;
    ...
    assign cfg_target[39]      = 16'd256;  // AND_P4_fanout_r2
    assign cfg_input_addr[39]  = 16'd259;
    assign cfg_output_addr[39] = 16'd260;
    ...
    assign cfg_cluster[39]     = 4'd8;

    assign cfg_target[40]      = 16'd257;  // OR_G4
    assign cfg_input_addr[40]  = 16'd257;
    assign cfg_output_addr[40] = 16'd258;
    ...
    assign cfg_target[41]      = 16'd258;  // DELAY_G5
    assign cfg_input_addr[41]  = 16'd258;
    assign cfg_output_addr[41] = 16'd289;
    ...
    assign cfg_target[42]      = 16'd288;  // DELAY_G5_fanout_r1
    assign cfg_input_addr[42]  = 16'd289;
    ...
    assign cfg_cluster[42]     = 4'd9;

    assign cfg_target[43]      = 16'd289;  // SHL_G5
    assign cfg_input_addr[43]  = 16'd289;
    assign cfg_output_addr[43] = 16'd259;
    ...
    assign cfg_cluster[43]     = 4'd9;

    assign cfg_target[44]      = 16'd228;  // SHL_P5
    assign cfg_input_addr[44]  = 16'd228;
    assign cfg_output_addr[44] = 16'd260;
    ...
    assign cfg_cluster[44]     = 4'd7;

    assign cfg_target[45]      = 16'd259;  // AND_PG5
    assign cfg_input_addr[45]  = 16'd259;
    ...
    assign cfg_cluster[45]     = 4'd8;

    assign cfg_target[46]      = 16'd260;  // AND_P5
    assign cfg_input_addr[46]  = 16'd260;
    ...
    assign prime_target[2] = 16'd33;
    assign prime_target[3] = 16'd34;
    assign prime_target[4] = 16'd64;
    assign prime_target[5] = 16'd65;
    assign prime_target[6] = 16'd3;
    assign prime_target[7] = 16'd66;
    assign prime_target[8] = 16'd96;
    assign prime_target[9] = 16'd67;
    assign prime_target[10] = 16'd97;
    assign prime_target[11] = 16'd98;
    assign prime_target[12] = 16'd68;
    assign prime_target[13] = 16'd128;
    assign prime_target[14] = 16'd129;
    assign prime_target[15] = 16'd160;
    assign prime_target[16] = 16'd161;
    assign prime_target[17] = 16'd162;
    assign prime_target[18] = 16'd131;
    assign prime_target[19] = 16'd192;
    assign prime_target[20] = 16'd193;
    assign prime_target[21] = 16'd194;
    assign prime_target[22] = 16'd224;
    assign prime_target[23] = 16'd225;
    assign prime_target[24] = 16'd195;
    assign prime_target[25] = 16'd227;
    assign prime_target[26] = 16'd256;
    assign prime_target[27] = 16'd258;
    assign prime_target[28] = 16'd288;
    assign prime_target[29] = 16'd289;
    assign prime_target[30] = 16'd228;
